        ...
        <Row>
          <Carousel>
            <Carousel.Item>
              <Carousel.Caption>
                <div className="user_img">
                  <img src={user1} alt="brand1" className="img-fluid" />
                </div>
                <p>
            ...
            <Carousel.Item>
              <Carousel.Caption>
                <div className="user_img">
                  <img src={user2} alt="brand2" className="img-fluid" />
                </div>
                <p>
                  " Etiam sapien sem at sagittis congue augue massa varius
                  sodales sapien undo tempus dolor egestas magna suscipit magna
            ...
            <Carousel.Item>
              <Carousel.Caption>
                <div className="user_img">
                  <img src={user3} alt="brand3" className="img-fluid" />
                </div>
                <p>
                  " Etiam sapien sem at sagittis congue augue massa varius
                  sodales sapien undo tempus dolor egestas magna suscipit magna
            ...
            <Carousel.Item>
              <Carousel.Caption>
                <div className="user_img">
                  <img src={user4} alt="brand4" className="img-fluid" />
                </div>
                <p>
                  " Etiam sapien sem at sagittis congue augue massa varius
                  sodales sapien undo tempus dolor egestas magna suscipit magna
